...
export default function RoomUserCard({uname, lastActive, proflieUrl, setSelectedRoom}: CardProps){

    return(
        //@ts-ignore
        <div className="flex flex-row  border-b-2 p-4 cursor-pointer hover:bg-gray-300" onClick={() => (console.log(uname), setSelectedRoom(uname))}>
