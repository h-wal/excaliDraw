export default function Users() {
    ...
    function Card({uname, lastActive, proflieUrl}: CardProps){
        return(
    ...
    return(
        <div className="bg-gray-100 rounded-2xl h-screen my-2">

            <Card uname="harsh" lastActive={25} />
            <Card uname="prakhar" lastActive={240} />
        </div>
    )
}